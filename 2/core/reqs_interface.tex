...
\xreq{r:ui_base}{Bazinio interfeiso reikalavimai:}
  ...
  \yreq{r:ui_base:messages}{Visų tipų pranešimai turi būti pateikiami baziniame interfeise.}
...
\xreq{r:ui_login}{Prieš pradedant bet kokį darbą su sistema, naudotojas turi
  prie jos prisijungti per tam skirtą interfeisą.}

\xreq{r:ui_dyn_upd}{Bet kurioje lentelėje pakeitus pradinius duomenis, sistema automatiškai
  turi atnaujinti atitinkamas rezultatų lenteles/grafikus.}
  
\xreq{r:ui_import}{Bet kuriuo momentu naudotojui turi būti galimybė importuoti istorinius
  duomenis/planuojamus paraiškų kiekius iš išorinio failo.}
...
ir kritiniai.
  ...
  \yreq{r:ui_messages:info}{
    Informacinis pranešimas praneša apie sistemos įvykį. Pavyzdžiui,
    „duomenys iš failo buvo sėkmingai importuoti“.
    }
  \yreq{r:ui_messages:warning}{
    Perspėjimo pranešimas praneša apie klaidą, kurią sistemai pavyko
    ištaisyti. Pavyzdžiui, „Sistemos vardas turi prasidėti didžiąja
    raide. Pakeista“.
    }
  \yreq{r:ui_messages:error}{
    Klaidos pranešimas praneša apie įvykusią darbo klaidą. Pavyzdžiui,
    „Duomenų failo eilutės X stulpelyje Y buvo tikėtasi datos
    formatu „metai-mėnuo-data“. Vietoje to rastas skaičius“.
    }
  \yreq{r:ui_messages:severe}{
    Kritinis pranešimas praneša apie įvykusią sistemos klaidą. Pavyzdžiui,
    „Nepavyko aktyvuoti komunikacijos su duomenų baze modulio“.
    }
...
informaciją, kuria naudodamasis sistemos administratorius galėtų
