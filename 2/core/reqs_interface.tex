...
\xreq{r:ui_base}{Bazinio interfeiso reikalavimai:}
  ...
  % čia abstraktu - kokie toolbarai, menu irasai, issidestymai numatys detalus reikalavimai/maketai
  \yreq{r:ui_base:mainwnd}{Pagrindinį langą turi sudaryti menu, įrankių
  ...
  naudotojui.}
  \yreq{r:ui_base:menu_toolbars}{Papildomos ir rečiau naudojamos funkcijos turi būti pasiekiamos
  per menu. Vidutiniškai dažnai naudojamos funkcijos turi būti pasiekiamos ir per užduočių
  juostas.}
