\begin{xcase}{Skambučių priėmimas Samsung GT-C5130S mobiliajame telefone}
  ...
  \xctools
  {
    ...
    \ximage{fig:case_m_3_calling}{Skambutis}{martynas/images/case_3_calling.png}
    \ximage{fig:case_m_3_number}{Skambutis}{martynas/images/case_3_number.png}
    \ximage{fig:case_m_3_empty}{Skambutis}{martynas/images/case_3_empty.png}
  }
