\begin{xcase}{Eclipse fono spalvos konfigūracija}
  ...
  \xctools
  {
    ...
    %
    \ximage{fig:eclipse_1}{Sintaksės spalvų konfigūracija}{audrius/images/eclipse_1.png}
    \ximage{fig:eclipse_2}{Anotacijų išvaizdos konfigūracija}{audrius/images/eclipse_3.png}
    \ximage{fig:eclipse_3}{Redaktoriaus spalvų konfigūracija}{audrius/images/eclipse_4.png}
  }
